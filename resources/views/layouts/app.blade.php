...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('assets/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet" href="{{ URL::asset('assets/icheck-bootstrap/icheck-bootstrap.min.css')}}">
    <!-- JQVMap -->
    <link rel="stylesheet" href="{{ URL::asset('assets/jqvmap/jqvmap.min.css') }}">
    <!-- Theme style -->
    ...
    <!-- summernote -->
    <link rel="stylesheet" href="{{ URL::asset('assets/summernote/summernote-bs4.css') }}">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item has-treeview menu-open">
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                      <a href="{{ URL::to('groups') }}" class="nav-link">
                        <i class="far fa-circle nav-icon"></i>
                        <p>Groups</p>
                      </a>
                    </li>
      ...
      <!-- /.control-sidebar -->
        ...
        <!-- Sparkline -->
        <script src="{{ URL::asset('assets/sparklines/sparkline.js') }}"></script>
        <!-- JQVMap -->
        <script src="{{ URL::asset('assets/qvmap/jquery.vmap.min.js') }}"></script>
        <script src="{{ URL::asset('assets/jqvmap/maps/jquery.vmap.usa.js') }}"></script>
        <!-- jQuery Knob Chart -->
        <script src="{{ URL::asset('assets/jquery-knob/jquery.knob.min.js') }}"></script>
        <!-- daterangepicker -->
        <script src="{{ URL::asset('assets/moment/moment.min.js') }}"></script>
        <script src="{{ URL::asset('assets/daterangepicker/daterangepicker.js') }}"></script>
        <!-- Tempusdominus Bootstrap 4 -->
        <script src="{{ URL::asset('assets/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}"></script>
        <!-- Summernote -->
